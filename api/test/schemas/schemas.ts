...
export const campaignFinanceTranXSD = `<xs:element name="transaction">
<xs:complexType>
<xs:sequence>
...
export const addressSchema = xmlWrapper(addressXSD);
...
export const campaignFinanceTranSchema = xmlWrapper(campaignFinanceTranXSD);
