...
export class Test1580370051619 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TYPE "contributions_status_enum" RENAME TO "_failed_contributions_status_enum"`);
        await queryRunner.query(`ALTER TYPE "_old_contributions_status_enum" RENAME TO contributions_status_enum""`);
        await queryRunner.query(`ALTER TABLE contributions ALTER COLUMN "status" TYPE contributions_status_enum USING status::text::contributions_status_enum`);
    }
